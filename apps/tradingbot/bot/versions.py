...
VERSIONS: Dict[str, Dict[str, Version]] = {
    ...
    "density": {
        ...
        # Зеркало 0.1: те же стены и те же цены срабатывания, но сделка в
        # противоположную сторону - ставка на пробой плотности, а не на отскок.
        "0.2": Version(
            notes="Всё как в 0.1, но сторона сделки обратная: bid-стена -> шорт, "
                  "ask-стена -> лонг (ставка на пробой плотности)",
            engine="bot.density_v2:DensityV2Engine",
        ),
    },
    "breakout": {
